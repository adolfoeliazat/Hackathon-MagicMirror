...
//  Copyright (c) 2015 NewStore. All rights reserved.
//
...
public struct GCD {
    ...
    */
    ...
    Schedule a block for execution on a given queue at a specified time. The given delay is in seconds.
     ...
     - parameter delay: the delay time in seconds.
     - parameter queue: the dispatch queue.
     - parameter block: the block to be executed.
    */
    ...
    Execute a block once and only once.
     ...
     - parameter predicate: a predicate for use with dispatch_once().
     - parameter block: the block to be executed.
    */
    ...
    */
    ...
    Returns a global queue with a specific QOS class
     - parameter QOSClass: the quality of service class
     - parameter flags: default value is 0
    ...
    */
    ...
    Creates a new dispatch queue to which blocks may be submitted.
     - parameter label: the queue label
     - parameter queueType: the queue type, the Default is serial
